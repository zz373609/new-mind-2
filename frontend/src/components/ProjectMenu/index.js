...
class ProjectMenu extends Component {
  render() {
    ...
    return <div key='projectmenu' style={{
      ...
      <div style={{ verticalAlign: 'middle', width: '250px', height: '150px', minWidth: 218, minHeight: 112, background: 'rgba(0,0,0,0.3)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {
